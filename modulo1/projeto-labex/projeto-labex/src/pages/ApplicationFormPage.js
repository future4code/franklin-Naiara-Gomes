...
export const ApplicationFormPage = () => {
  ...
  async function handleSubmit (e) {
    e.preventDefault(); 
    console.log(viagem)
   axios.post(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/naiara-gomes-franklin/trips/${viagem.id}/apply`,{
    name: nome,
    age: idade,
  ...
  return (
    <form className="Inscreva-se" onSubmit={(e)=>handleSubmit(e)}>
